...
export const physicalCoordinatesToThreeCoordinates = (x, y) => {
    let ratioX = x/physicalDimensions.length;
    ratioX = ratioX <= 1 ? ratioX : 1;
    let ratioY = y/physicalDimensions.width;
    ratioY = ratioX <= 1 ? ratioX : 1;
...
// export const physicalCoordinatesToGridCoordinates = (x, y) => {
//     const threeCoord = physicalCoordinatesToThreeCoordinates(x, y);
//     return {
